...
- Frecuencia (Laura): Crear una función que nos muestre la popularidad. El algoritmo consiste en crear un vector y ordenar de mayor a menor las actividades con más popularidad. Se hace con el algoritmo de la burbuja. Se añadirá también la  representación gráfica.
